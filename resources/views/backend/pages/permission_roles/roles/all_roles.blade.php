        ...
        <div class="page-header">
            <div class="row align-items-end">
                ...
                <div class="col-sm-auto">
                    <!-- Nav -->
                    <a class="btn btn-primary" href="{{route('backend.add.roles')}}">
                        <i class="bi bi-plus-lg me-1"></i> Create Roles
                    </a>
                    <!-- End Nav -->
                </div>
                <!-- End Col -->
                        ...
                        <tr>
                            ...
                            <th class="table-column-ps-0">
                                <div class="btn-group" role="group" aria-label="Edit group">
                                    <a class="btn btn-white" href="{{route('backend.edit.roles', $role->id)}}">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="card-body card-body-centered">
                                    ...
                                    <a class="btn btn-white btn-sm" href="{{route('backend.add.roles')}}">Create new roles</a>
                                </div>
                            </td>
                        </tr>
                    @endforelse
            ...
            <div class="modal fade" id="delete_role" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{route('backend.delete.roles')}}" method="get">@csrf
